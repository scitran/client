function nWarnings = dataCheck(obj)
% dataCheck - Test whether the data files in a BIDS structure exist
%
% Prints out a message if data
% Returns
%   nWarnings is number of warnings. 
%
%   @bids.dataCheck
%
% DH/BW Scitran 2017
