...
%
% When there is a problem processing a subject, say we have many,
% rather than stop the analysis we mark this subject as problematic by
% putting the data in a temporary collection.  Then we figure this out
% later.
%
