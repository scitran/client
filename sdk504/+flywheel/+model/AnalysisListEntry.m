% AnalysisListEntry
%
% AnalysisListEntry Properties:
%    id           - Unique database ID
%    inputs      
%    files       
%    job          - Unique database ID
%    gearInfo    
%    notes       
%    description 
...
%
% AnalysisListEntry Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef AnalysisListEntry < flywheel.ModelBase & flywheel.mixins.AnalysisMixin
    % NOTE: This file is auto generated by the swagger code generator program.
    % Do not edit the file manually.
    properties (Constant)
        propertyMap = containers.Map({ 'id', 'inputs', 'files', 'job', 'gearInfo', 'notes', 'description', 'label', 'parent', 'parents', 'created', 'modified' }, ...
            { '_id', 'inputs', 'files', 'job', 'gear_info', 'notes', 'description', 'label', 'parent', 'parents', 'created', 'modified' });
    end
    ...
    methods
        function obj = AnalysisListEntry(varargin)
            obj@flywheel.ModelBase(flywheel.model.AnalysisListEntry.propertyMap);
        ...
        function result = toJson(obj)
            ...
            if isKey(obj.props_, 'job')
                result('job') = flywheel.ModelBase.serializeValue(obj.props_('job'), 'char');
            end
            if isKey(obj.props_, 'gear_info')
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.AnalysisListEntry;
            ...
            if isfield(json, 'job')
                obj.props_('job') = flywheel.ModelBase.deserializeValue(json.job, 'char');
            end
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.AnalysisListEntry')
                    obj = flywheel.model.AnalysisListEntry(obj);
                end
                if isKey(obj.props_, '_id')
                end
                if isKey(obj.props_, 'inputs')
