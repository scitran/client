% InlineResponse2001
%
% InlineResponse2001 Properties:
%    deleted 
%
% InlineResponse2001 Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef InlineResponse2001 < flywheel.ModelBase
    ...
    methods
        function obj = InlineResponse2001(varargin)
            obj@flywheel.ModelBase(flywheel.model.InlineResponse2001.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.InlineResponse2001;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.InlineResponse2001')
                    obj = flywheel.model.InlineResponse2001(obj);
                end
                if isKey(obj.props_, 'deleted')
                end
            end
