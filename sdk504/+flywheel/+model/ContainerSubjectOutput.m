...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'id', 'project', 'public', 'firstname', 'lastname', 'age', 'sex', 'cohort', 'type', 'race', 'ethnicity', 'species', 'strain', 'label', 'code', 'tags', 'info', 'files', 'parents', 'created', 'modified', 'permissions', 'notes', 'infoExists', 'analyses' }, ...
            { '_id', 'project', 'public', 'firstname', 'lastname', 'age', 'sex', 'cohort', 'type', 'race', 'ethnicity', 'species', 'strain', 'label', 'code', 'tags', 'info', 'files', 'parents', 'created', 'modified', 'permissions', 'notes', 'info_exists', 'analyses' });
    end
