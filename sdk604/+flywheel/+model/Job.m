...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'id', 'origin', 'gearId', 'gearInfo', 'previousJobId', 'inputs', 'destination', 'group', 'project', 'tags', 'state', 'failureReason', 'attempt', 'created', 'modified', 'retried', 'config', 'transitions', 'request', 'savedFiles', 'profile', 'relatedContainerIds', 'label' }, ...
            { 'id', 'origin', 'gear_id', 'gear_info', 'previous_job_id', 'inputs', 'destination', 'group', 'project', 'tags', 'state', 'failure_reason', 'attempt', 'created', 'modified', 'retried', 'config', 'transitions', 'request', 'saved_files', 'profile', 'related_container_ids', 'label' });
    end
