...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'projectId', 'gearId', 'name', 'config', 'fixedInputs', 'autoUpdate', 'any', 'all', 'not', 'disabled', 'id' }, ...
            { 'project_id', 'gear_id', 'name', 'config', 'fixed_inputs', 'auto_update', 'any', 'all', 'not', 'disabled', '_id' });
    end
