...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'public', 'label', 'info', 'metadata', 'measurement', 'instrument', 'uid', 'tags', 'timestamp', 'timezone', 'files' }, ...
            { 'public', 'label', 'info', 'metadata', 'measurement', 'instrument', 'uid', 'tags', 'timestamp', 'timezone', 'files' });
    end
