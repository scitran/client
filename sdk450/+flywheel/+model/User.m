...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'id', 'firstname', 'lastname', 'email', 'avatar', 'avatars', 'root', 'disabled', 'preferences', 'wechat', 'firstlogin', 'lastlogin', 'created', 'modified', 'apiKey' }, ...
            { '_id', 'firstname', 'lastname', 'email', 'avatar', 'avatars', 'root', 'disabled', 'preferences', 'wechat', 'firstlogin', 'lastlogin', 'created', 'modified', 'api_key' });
    end
