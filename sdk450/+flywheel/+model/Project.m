...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'public', 'label', 'info', 'description', 'group', 'id', 'parents', 'infoExists', 'created', 'modified', 'templates', 'permissions', 'files', 'notes', 'tags', 'analyses' }, ...
            { 'public', 'label', 'info', 'description', 'group', '_id', 'parents', 'info_exists', 'created', 'modified', 'templates', 'permissions', 'files', 'notes', 'tags', 'analyses' });
    end
