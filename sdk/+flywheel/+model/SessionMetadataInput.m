...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'public', 'label', 'info', 'operator', 'uid', 'timestamp', 'timezone', 'subject', 'tags', 'age', 'weight', 'files' }, ...
            { 'public', 'label', 'info', 'operator', 'uid', 'timestamp', 'timezone', 'subject', 'tags', 'age', 'weight', 'files' });
    end
