...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'parent', 'label', 'description', 'public', 'columns', 'fileSpec', 'includeIds', 'includeLabels', 'missingDataStrategy', 'id', 'origin' }, ...
            { 'parent', 'label', 'description', 'public', 'columns', 'fileSpec', 'includeIds', 'includeLabels', 'missingDataStrategy', '_id', 'origin' });
    end
