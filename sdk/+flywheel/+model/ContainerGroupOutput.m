...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'id', 'label', 'permissions', 'created', 'modified', 'tags', 'providers', 'editions' }, ...
            { '_id', 'label', 'permissions', 'created', 'modified', 'tags', 'providers', 'editions' });
    end
