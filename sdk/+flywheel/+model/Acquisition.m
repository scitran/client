...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'public', 'label', 'info', 'session', 'uid', 'timestamp', 'timezone', 'id', 'parents', 'collections', 'files', 'created', 'modified', 'infoExists', 'permissions', 'notes', 'tags', 'analyses' }, ...
            { 'public', 'label', 'info', 'session', 'uid', 'timestamp', 'timezone', '_id', 'parents', 'collections', 'files', 'created', 'modified', 'info_exists', 'permissions', 'notes', 'tags', 'analyses' });
    end
