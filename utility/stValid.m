...
%
% Syntax
%    validStrings = stValid(param,value)
%
% Description
%   Returns the valid strings for several scitran functions.  If a string
%   is provided as a second argument, the return is a logical confirming
%   whether or not the string is valid.
%
% Inputs
%   param: One of {'filetype','datatype','searchreturn','measurement'}
%
% Optional
...
%
% Outputs
%   validStrings:  Cell array of valid values, or a logical (true/false)
%                  if str parameter is included
%
% ** Note: This functionality should be included by Flywheel in the SDK **
%
