% ContainerUpdate - Generic input, should be validated by the correct schema later on
%
% ContainerUpdate Properties:
%
% ContainerUpdate Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef ContainerUpdate < flywheel.ModelBase
    ...
    methods
        function obj = ContainerUpdate(varargin)
            obj@flywheel.ModelBase(flywheel.model.ContainerUpdate.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.ContainerUpdate;
            if ~isempty(json)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.ContainerUpdate')
                    obj = flywheel.model.ContainerUpdate(obj);
                end
            end
        end
    end
