% GearCustom - A place for gear authors to put arbitrary information.
%
% GearCustom Properties:
%
% GearCustom Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef GearCustom < flywheel.ModelBase
    ...
    methods
        function obj = GearCustom(varargin)
            obj@flywheel.ModelBase(flywheel.model.GearCustom.propertyMap);
    ...
    methods(Static)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.GearCustom')
                    obj = flywheel.model.GearCustom(obj);
                end
            end
        end
    end
