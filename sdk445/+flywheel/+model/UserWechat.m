% UserWechat
%
% UserWechat Properties:
%
% UserWechat Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef UserWechat < flywheel.ModelBase
    ...
    methods
        function obj = UserWechat(varargin)
            obj@flywheel.ModelBase(flywheel.model.UserWechat.propertyMap);
    ...
    methods(Static)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.UserWechat')
                    obj = flywheel.model.UserWechat(obj);
                end
            end
        end
    end
