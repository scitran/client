...
%    struct - Convert the object to a struct
    classdef UserPreferences < flywheel.ModelBase
    ...
    methods
        function obj = UserPreferences(varargin)
            obj@flywheel.ModelBase(flywheel.model.UserPreferences.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.UserPreferences;
            if ~isempty(json)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.UserPreferences')
                    obj = flywheel.model.UserPreferences(obj);
                end
            end
        end
    end
