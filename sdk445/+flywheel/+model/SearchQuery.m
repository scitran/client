...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'returnType', 'searchString', 'allData', 'filters' }, ...
            { 'return_type', 'search_string', 'all_data', 'filters' });
    end
    ...
    methods
        ...
        function result = toJson(obj)
            ...
            if isKey(obj.props_, 'filters')
                result('filters') = flywheel.ModelBase.serializeValue(obj.props_('filters'), 'containers.Map');
            end
        end
    ...
    methods(Static)
        function obj = fromJson(json, context)
            ...
            if isfield(json, 'filters')
                obj.props_('filters') = flywheel.ModelBase.deserializeValue(json.filters, 'containers.Map');
            end
