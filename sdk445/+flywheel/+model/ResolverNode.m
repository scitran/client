...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        ...
        discriminatorValueClassMap = containers.Map({ 'analysis', 'project', 'acquisition', 'group', 'file', 'gear', 'session', 'subject' }, ...
            { 'flywheel.model.ResolverAnalysisNode.fromJson', 'flywheel.model.ResolverProjectNode.fromJson', 'flywheel.model.ResolverAcquisitionNode.fromJson', 'flywheel.model.ResolverGroupNode.fromJson', 'flywheel.model.ResolverFileNode.fromJson', 'flywheel.model.ResolverGearNode.fromJson', 'flywheel.model.ResolverSessionNode.fromJson', 'flywheel.model.ResolverSubjectNode.fromJson' });
    end
