...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        ...
        discriminatorValueClassMap = containers.Map({ 'acquisition', 'analysis', 'project', 'collection', 'session', 'group' }, ...
            { 'flywheel.model.SearchParentAcquisition.fromJson', 'flywheel.model.SearchParentAnalysis.fromJson', 'flywheel.model.SearchParentProject.fromJson', 'flywheel.model.SearchParentCollection.fromJson', 'flywheel.model.SearchParentSession.fromJson', 'flywheel.model.SearchParentGroup.fromJson' });
    end
