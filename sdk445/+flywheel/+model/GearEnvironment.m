% GearEnvironment - Environment variables that should be set for the gear.
%
% GearEnvironment Properties:
%
% GearEnvironment Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef GearEnvironment < flywheel.ModelBase
    ...
    methods
        function obj = GearEnvironment(varargin)
            obj@flywheel.ModelBase(flywheel.model.GearEnvironment.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.GearEnvironment;
            if ~isempty(json)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.GearEnvironment')
                    obj = flywheel.model.GearEnvironment(obj);
                end
            end
        end
    end
