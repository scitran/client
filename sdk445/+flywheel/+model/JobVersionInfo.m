% JobVersionInfo - An object that contains known version info for components involved in the job
%
% JobVersionInfo Properties:
%
% JobVersionInfo Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef JobVersionInfo < flywheel.ModelBase
    ...
    methods
        function obj = JobVersionInfo(varargin)
            obj@flywheel.ModelBase(flywheel.model.JobVersionInfo.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.JobVersionInfo;
            if ~isempty(json)
                ...
                for i = 1:length(keys)
                    ...
                    obj.props_(name) = flywheel.ModelBase.deserializeValue(value, 'char');
                end
            end
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.JobVersionInfo')
                    obj = flywheel.model.JobVersionInfo(obj);
                end
            end
        end
    end
