% GearDirective - A schema directive.
%
% GearDirective Properties:
%
% GearDirective Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef GearDirective < flywheel.ModelBase
    ...
    methods
        function obj = GearDirective(varargin)
            obj@flywheel.ModelBase(flywheel.model.GearDirective.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.GearDirective;
            if ~isempty(json)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.GearDirective')
                    obj = flywheel.model.GearDirective(obj);
                end
            end
        end
    end
