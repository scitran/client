...
%
% SearchParentAnalysis Properties:
...
%
% SearchParentAnalysis Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef SearchParentAnalysis < flywheel.ModelBase & flywheel.mixins.AnalysisMixin
    % NOTE: This file is auto generated by the swagger code generator program.
    % Do not edit the file manually.
    properties (Constant)
        propertyMap = containers.Map({ 'id', 'inputs', 'files', 'job', 'gearInfo', 'notes', 'tags', 'info', 'description', 'label', 'parent', 'parents', 'created', 'modified' }, ...
            { '_id', 'inputs', 'files', 'job', 'gear_info', 'notes', 'tags', 'info', 'description', 'label', 'parent', 'parents', 'created', 'modified' });
    end
    ...
    methods
        function obj = SearchParentAnalysis(varargin)
            obj@flywheel.ModelBase(flywheel.model.SearchParentAnalysis.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.SearchParentAnalysis;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.SearchParentAnalysis')
                    obj = flywheel.model.SearchParentAnalysis(obj);
                end
                if isKey(obj.props_, '_id')
                end
                if isKey(obj.props_, 'inputs')
