...
%    struct - Convert the object to a struct
    classdef JobConfig < flywheel.ModelBase
    ...
    methods
        function obj = JobConfig(varargin)
            obj@flywheel.ModelBase(flywheel.model.JobConfig.propertyMap);
    ...
    methods(Static)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.JobConfig')
                    obj = flywheel.model.JobConfig(obj);
                end
            end
        end
    end
