...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        ...
        discriminatorValueClassMap = containers.Map({ 'group', 'project', 'acquisition', 'session', 'file', 'analysis', 'collection', 'subject' }, ...
            { 'flywheel.model.ContainerGroupOutput.fromJson', 'flywheel.model.ContainerProjectOutput.fromJson', 'flywheel.model.ContainerAcquisitionOutput.fromJson', 'flywheel.model.ContainerSessionOutput.fromJson', 'flywheel.model.ContainerFileOutput.fromJson', 'flywheel.model.ContainerAnalysisOutput.fromJson', 'flywheel.model.ContainerCollectionOutput.fromJson', 'flywheel.model.ContainerSubjectOutput.fromJson' });
    end
