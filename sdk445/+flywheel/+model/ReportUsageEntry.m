% ReportUsageEntry - An entry in the usage report, describing storage and gear usage
%
    ...
    methods(Static)
        function obj = fromJson(json, context)
            ...
            if isfield(json, 'project')
                obj.props_('project') = flywheel.model.ReportUsageProjectEntry.fromJson(json.project, context);
            end
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if isKey(obj.props_, 'project')
                    obj.props_('project') =  flywheel.model.ReportUsageProjectEntry.ensureIsInstance(obj.props_('project'));
                end
            end
        end
    end
