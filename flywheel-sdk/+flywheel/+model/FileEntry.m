...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'id', 'name', 'type', 'mimetype', 'modality', 'deidLogId', 'classification', 'tags', 'info', 'origin', 'hash', 'created', 'modified', 'replaced', 'size', 'infoExists', 'zipMemberCount' }, ...
            { '_id', 'name', 'type', 'mimetype', 'modality', 'deid_log_id', 'classification', 'tags', 'info', 'origin', 'hash', 'created', 'modified', 'replaced', 'size', 'info_exists', 'zip_member_count' });
    end
